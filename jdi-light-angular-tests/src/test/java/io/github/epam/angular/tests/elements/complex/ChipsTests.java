...
public class ChipsTests extends TestsInit {
    ...
    public void chipsAutocompleteTest() {
        ...
        //chipsAutocompleteField.deleteChip(ORANGE);
        //autocompleteChipsList.deleteChip(ORANGE);
    ...
    public void chipsWithInputTest() {
        ...
        //chipsWithInputField.deleteChip("Rockmelon");
        //chipsWithInputList.deleteChip("Rockmelon");
    }
}
