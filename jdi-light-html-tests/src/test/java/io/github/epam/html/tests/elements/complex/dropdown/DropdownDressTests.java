...
import static com.epam.jdi.light.asserts.core.SoftAssert.assertResults;
...
public class DropdownDressTests implements TestsInit {
...
//        dressCode2.show();
//
//        jdiAssert(dressCode2.isExpanded(), is(false));
//        dressCode2.expand();
//        jdiAssert(dressCode2.isExpanded(), is(true));
//        dressCode2.close();
//        jdiAssert(dressCode2.isExpanded(), is(false));
//
//        // Verify that list is ok after expand/close
//        jdiAssert(dressCode2.listEnabled(), hasItems("Fancy", "Casual", "Pirate"));
//        jdiAssert(dressCode2.listDisabled(), hasItems("Disabled"));
//        jdiAssert(dressCode2.values(), hasItems("Fancy", "Casual", "Disabled", "Pirate"));
//
//        assertResults();
//    }
}
