...
public class DropdownEx2Tests extends TestsInit {
    ...
    public void isValidationTest() {
        ...
        colors2.is().values(INNER_TEXT, hasItem("Yellow"));
    }

    @Test
    public void assertValidationTest() {
        colors2.assertThat().values(INNER_TEXT, contains("Colors", "Red", "Green", "Blue", "Yellow"));
    }
    @Test
    public void innerValuesTest() {
        assertThat(colors2.values(INNER_TEXT), hasItems("Colors", "Red", "Green", "Blue", "Yellow"));
    }
    @Test
