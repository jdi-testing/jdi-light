...
public class DropdownCustomTests implements TestsInit {
    ...
    public void selectIndexTest() {
        colorsCustom.select(ELEMENT.startIndex + 3);
        lastLogEntry.assertThat()
    ...
    public void negativeDropdownTest() {
        try {
            ...
            assertThat(safeException(ex), containsString("Failed to get 'GreyBrownCrimson' in list 'Colors Custom list'. No elements with this name found"));
        }
    }
