...
public class DropdownEx3Tests implements TestsInit {
    ...
    public void selectIndexTest() {
        colors3.select(ELEMENT.startIndex + 3);
        lastLogEntry.assertThat()
    ...
    public void negativeDropdownTest() {
        try {
            ...
            assertThat(safeException(ex), containsString("Failed to get 'GreyBrownCrimson' in list 'Colors3 list'. No elements with this name found"));
        }
    }
