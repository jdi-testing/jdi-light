...
public class DropdownExTests implements TestsInit {
    ...
    public void selectIndexTest() {
        colors.select(ELEMENT.startIndex + 3);
        lastLogEntry.assertThat()
    ...
    public void negativeDropdownTest() {
        try {
            ...
            assertThat(safeException(ex), containsString("Failed to get 'GreyBrownCrimson' in list 'Colors list'. No elements with this name found"));
        }
    }
