...
public class FileUploadTests implements TestsInit {
    private final CommonSettings commonSettings = getCommonSettings();
    ...
    public void uploadTest() {
        avatar.uploadFile(mergePath(commonSettings.projectPath, "/src/test/resources/general.xml"));
    ...
    public void disabledUploadTest() {
        try {
            disabledFileInput.uploadFile(mergePath(commonSettings.projectPath, "/src/test/resources/general.xml"));
    ...
    private void createTextFile(String fileName) throws IOException {
        File txtFile = new File(mergePath(jdiSettings.DRIVER.downloadsFolder, fileName));
