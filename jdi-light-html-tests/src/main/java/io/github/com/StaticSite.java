...
public class StaticSite {
    ...
    @Url("/suspend-html-page.html")
    public static HtmlElementsPage suspendHtml5Page;
    @Url("/dates.html")
    @Title("Dates")
    ...
    @Css("[ui=label]")
    public static UIElement navigationElement;
    ...
    @UI("//*[@class='sidebar-menu']//span/..//*[text()='%s']/../..")
    public static WebList leftMenuList;
    //TODO
    //@UI(".sidebar-menu span<[*'%s']<<") public static WebList leftMenuList;
    @UI(".sidebar-menu span")
    public static JList<MenuItem> menu;
    @NoInheritance
    @JMenu({"[ui=label][*'%s']", "[ui=label][*'%s']"})
    public static Menu2D leftMenu2D;
    @JMenu({"[ui=label] span", "../..//ul//li[@ui='label']"})
