...
public class SearchPage extends BaseSelPage {
    ...
    @UI(".box")
    public static List<SearchResult> search3;
    @UI(".box")
    @WaitTimeout(2)
    ...
    @UI(".box")
    public JList<SearchResult> jsearch2;
    @UI(".box")
    public static JList<SearchResult> jsearchS;
    @UI(".wrong-locator")
    public static JList<SearchResult> jEmptySearch;
    @UI(".box h3")
