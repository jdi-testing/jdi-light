...
import static pseudo.site.PseudoSiteUtils.customWebPageUI;
...
public class CustomWebPageUIDataProvider {
    ...
    public Object[][] customWebPageUIDropDownDataProvider() {
        return new Object[][]{
                {customWebPageUI.getDropdownPackage(), "css='div[ui=droplistPackage'", customWebPageUI, "Droplist Package"},
                {customWebPageUI.droplistPublic, "css='div[ui=droplistPublic'", customWebPageUI, "Droplist Public"},
                {customWebPageUI.getDropdownPrivate(), "css='div[ui=droplistPrivate'", customWebPageUI, "Droplist Private"},
                {customWebPageUI.getDropdownPackageUI(), "css='.droplistPackageUI'", customWebPageUI, "Droplist Package UI"},
