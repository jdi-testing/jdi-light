...
public class NavigationDrawerAssert extends UIAssert<NavigationDrawerAssert, NavigationDrawer>
    ...
    @JDIAction(value = "Assert that '{name}' has expected number of items")
    ...
    @JDIAction(value = "Assert that '{name}' is opened")
    ...
    @JDIAction(value = "Assert that '{name}' is located on the right side")
    ...
    @JDIAction(value = "Check '{name}' text of items using specific condition")
    ...
    @JDIAction(value = "Assert that '{name}' has no overlay")
    ...
    @JDIAction(value = "Assert that theme of '{name}' is expanded on hover")
