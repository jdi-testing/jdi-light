...
public class RangeSliderAssert extends UIAssert<RangeSliderAssert, RangeSlider> implements OrientationAssert<RangeSliderAssert, RangeSlider>,
    ...
    @JDIAction(value = "Assert that value {name} is {0}, {1}")
    ...
    @JDIAction(value = "Assert that max value {name} is {0}")
    ...
    @JDIAction(value = "Assert that thumb label value {name} is {0}, {1}")
    ...
    @JDIAction(value = "Assert that thumb label {name} is displayed")
    ...
    @JDIAction(value = "Assert that thumb label {name} is not displayed")
    ...
    @JDIAction(value = "Assert that {name} tick size is {0}")
    ...
    @JDIAction(value = "Assert that {name} {0} tick label is {1}")
    ...
    @JDIAction(value = "Assert that '{name}' track background color is '{0}'")
    ...
    @JDIAction(value = "Assert that '{name}' left thumb size is '{0}'")
