...
public class InputAssert extends UIAssert<InputAssert, Input>
    ...
    @JDIAction(value = "Assert that '{name}' has text field")
    ...
    @JDIAction(value = "Assert that '{name}' has typed text in input field")
    public InputAssert typedText() {
        jdiAssert(element().hasTypedText(), Matchers.is(true), "Element hasn't typed text");
        return this;
    }

    @JDIAction(value = "Assert that '{name}' has typed text '{0}' in input field")
    ...
    @JDIAction(value = "Assert that '{name}' has not typed text in input field")
    public InputAssert notTypedText() {
        jdiAssert(element().hasTypedText(), Matchers.is(true), "Element has typed text");
        return this;
    }

    @JDIAction(value = "Assert that '{name}' has empty input field")
    ...
    @JDIAction(value = "Assert that '{name}' has label '{0}'")
    ...
    @JDIAction(value = "Assert that '{name}' has not class attribute '{0}'")
