...
public class ChipAssert extends UIAssert<ChipAssert, Chip> implements ColorAssert<ChipAssert, Chip>,
    ...
    @Override
    @JDIAction(value = "Assert that '{name}' has text '{0}'")
    ...
    @JDIAction(value = "Assert that '{name}' has border color with code '{0}'")
    ...
    @JDIAction(value = "Assert that ''{name}' filter icon is not displayed'")
    ...
    @JDIAction(value = "Assert that '{name}' has image")
    public ChipAssert image() {
        jdiAssert(element().hasImage(), Matchers.is(true), "Element has not image");
        return this;
    }

    @JDIAction(value = "Assert that '{name}' font size is equal to '{0} px'")
    ...
    @JDIAction(value = "Assert that '{name}' is pill")
    public ChipAssert pill() {
        jdiAssert(element().isPill(), Matchers.is(true), "Element is not pill");
        return this;
    }

    @JDIAction(value = "Assert that '{name}' is not pill")
