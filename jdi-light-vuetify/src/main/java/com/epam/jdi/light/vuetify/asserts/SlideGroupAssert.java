...
public class SlideGroupAssert extends UIAssert<SlideGroupAssert, SlideGroup>
    ...
    @JDIAction(value = "Assert that '{name}' slide on index {0} is selected")
    ...
    @JDIAction(value = "Assert that '{name}' slide on index {0} is not selected")
    ...
    @JDIAction(value = "Assert that '{name}' icon is visible")
