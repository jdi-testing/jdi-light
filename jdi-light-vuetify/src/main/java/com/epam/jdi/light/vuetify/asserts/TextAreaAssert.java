...
public class TextAreaAssert extends UIAssert<TextAreaAssert, TextArea> implements ITextAssert<TextAreaAssert>,
    ...
    @JDIAction(value = "Assert that '{name}' has lines {0}")
    ...
    @JDIAction(value = "Assert that '{name}' has not prefix")
    ...
    @JDIAction(value = "Assert that '{name}' has placeholder text '{0}'")
    ...
    @JDIAction(value = "Assert that '{name}' has counter value '{0}'")
    public TextAreaAssert counterValue(int n) {
        jdiAssert(element().counterValue(), Matchers.equalTo(n));
        return this;
    }

    @JDIAction(value = "Assert that '{name}' is autofocused")
    ...
    @JDIAction(value = "Assert that '{name}' hint message is '{0}'")
