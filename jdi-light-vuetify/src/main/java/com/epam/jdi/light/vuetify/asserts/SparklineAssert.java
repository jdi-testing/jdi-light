...
public class SparklineAssert extends UIAssert<SparklineAssert, Sparkline> implements
    ...
    @JDIAction(value = "Assert that all '{name}' data point labels have a '{0}' prefix")
    ...
    @JDIAction(value = "Assert that all '{name}' data point labels have a '{0}' postfix")
    ...
    @JDIAction(value = "Assert that '{name}' linear gradient map corresponds to the provided map {0}")
    ...
    @JDIAction(value = "Assert that '{name}' SVG path shape is equal to the provided path shape")
    ...
    @JDIAction(value = "Assert that '{name}' SVG path shape is not equal to the provided path shape")
    ...
    @JDIAction(value = "Assert that '{name}' has type bar")
    ...
    @JDIAction(value = "Assert that '{name}' labels has font size '{0}'")
    ...
    @JDIAction(value = "Assert that '{name}' has visible labels")
    public SparklineAssert labels() {
        jdiAssert(element().hasLabels(), Matchers.is(true), "Element has no visible labels");
        return this;
    }

    @JDIAction(value = "Assert that '{name}' has not visible labels")
    ...
    @JDIAction(value = "Assert that '{name}' has line width '{0}'")
    ...
    @JDIAction(value = "Assert that '{name}' has bars width '{0}'")
    ...
    @JDIAction(value = "Assert that '{name}' has bar width '{0}'")
    ...
    @JDIAction(value = "Assert that '{name}' has bars height '{0}'")
