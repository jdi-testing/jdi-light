...
public class VueCheckboxAssert extends UIAssert<VueCheckboxAssert, VueCheckbox> implements ThemeAssert<VueCheckboxAssert, VueCheckbox>,
    ...
    @JDIAction(value = "Assert that '{name}' label contains '{text}'")
