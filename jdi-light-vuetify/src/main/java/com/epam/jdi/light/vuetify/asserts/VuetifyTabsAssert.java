...
public class VuetifyTabsAssert extends UISelectAssert<VuetifyTabsAssert, VuetifyTabs> implements
    ...
    @JDIAction("Assert that '{name}' tab with index '{0}' doesn't exist")
    ...
    @JDIAction("Assert that '{name}' tab text content is '{0}'")
    ...
    @JDIAction("Assert that '{name}' is not align with title")
    ...
    @JDIAction("Assert that '{name}' has tab slider size '{0}'")
    ...
    @JDIAction("Assert that '{name}' has tab slider color '{0}'")
    ...
    @JDIAction("Assert that '{name}' tab '{0}' is disabled")
    ...
    @JDIAction("Assert that '{name}' tab '{0}' is enabled")
    ...
    @JDIAction("Assert that '{name}' tab '{0}' has href")
    ...
    @JDIAction("Assert that '{name}' tab '{0}' has no href")
