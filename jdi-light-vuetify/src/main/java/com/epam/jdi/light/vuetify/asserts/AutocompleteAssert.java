...
public class AutocompleteAssert extends UIAssert<AutocompleteAssert, Autocomplete> {
    ...
    @JDIAction(value = "Assert that 'name' has solo style")
    ...
    @JDIAction(value = "Assert that 'name' has filled style")
    ...
    @JDIAction(value = "Assert that 'name' has solo-inverted style")
    ...
    @JDIAction(value = "Assert that 'name' has outlined style")
    ...
    @JDIAction(value = "Assert that 'name' has dense style")
    ...
    @JDIAction(value = "Assert that 'name' has shaped style")
    ...
    @JDIAction(value = "Assert that 'name' has rounded style")
    ...
    @JDIAction(value = "Assert that 'name' has dark style")
