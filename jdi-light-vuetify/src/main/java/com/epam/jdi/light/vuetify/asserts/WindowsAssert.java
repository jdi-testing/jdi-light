...
public class WindowsAssert extends UIAssert<WindowsAssert, Windows> implements ThemeAssert<WindowsAssert, Windows> {
    @JDIAction(value = "Assert that '{name}' shows arrows on hover")
    ...
    @JDIAction(value = "Assert that '{name}' doesn't show arrows on hover")
    ...
    @JDIAction(value = "Assert that '{name}' has no next actions button")
    ...
    @JDIAction(value = "Assert that '{name}' has previous button")
    ...
    @JDIAction(value = "Assert that '{name}' has no previous button")
    ...
    @JDIAction(value = "Assert that '{name}' has next button")
    ...
    @JDIAction(value = "Assert that '{name}' has no next button")
