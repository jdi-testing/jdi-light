...
public class ProgressCircularAssert extends UIAssert<ProgressCircularAssert, ProgressCircular> {
    ...
    @JDIAction(value = "Assert that '{name}' has line thickness")
