...
public class CarouselAssert extends UIAssert<CarouselAssert, Carousel> implements ColorAssert<CarouselAssert, Carousel>,
    ...
    @JDIAction(value = "Assert that '{name}' hides delimiters")
    ...
    @JDIAction(value = "Assert that '{name}' has vertical delimiters")
    ...
    @JDIAction(value = "Assert that '{name}' has horizontal delimiters")
