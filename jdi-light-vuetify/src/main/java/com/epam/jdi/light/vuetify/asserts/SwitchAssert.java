...
public class SwitchAssert extends UIAssert<SwitchAssert, Switch>
    ...
    @JDIAction(value = "Assert that '{name}' is checked")
    ...
    @JDIAction(value = "Assert that '{name}' is unchecked")
    ...
    @JDIAction(value = "Assert that '{name}' has background color {0}")
    ...
    @JDIAction(value = "Assert that '{name}' has slot's background color {0}")
    ...
    @JDIAction(value = "Assert that '{name}' has error message {0}")
    ...
    @JDIAction(value = "Assert that '{name}' has not message")
    ...
    @JDIAction(value = "Assert that '{name}' has error message")
    public SwitchAssert errorMessage() {
        jdiAssert(element().hasErrorMessage(), Matchers.is(true), "Element has not error messages");
        return this;
    }

    @JDIAction(value = "Assert that number of {name}'s error messages is {0}")
    ...
    @JDIAction(value = "Assert that '{name}' has error messages {0}")
    ...
    @JDIAction(value = "Assert that '{name}' has not error message")
    ...
    @JDIAction(value = "Assert that '{name}' has success messages {0}")
    ...
    @JDIAction(value = "Assert that '{name}' has not success message")
