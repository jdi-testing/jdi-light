...
public class OverflowButtonAssert extends UIAssert<OverflowButtonAssert, OverflowButton> implements
    ...
    @JDIAction(value = "Assert that '{name}' selected value is '{0}'")
    ...
    @JDIAction(value = "Assert that '{name}' placeholder has text '{0}'")
