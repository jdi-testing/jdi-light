...
public class DatePickerMonthAssert extends UIAssert<DatePickerMonthAssert, DatePickerMonth> implements
    ...
    @JDIAction(value = "Assert that '{name}' next year icon class is correct")
    ...
    @JDIAction(value = "Assert that '{name}' previous year icon class is correct")
    ...
    @JDIAction(value = "Assert that '{name}' has additional year icon")
    ...
    @JDIAction(value = "Assert that '{name}' additional year icon class is correct")
    ...
    @JDIAction(value = "Assert that '{name}' list of enabled months is not empty")
    ...
    @JDIAction(value = "Assert that '{name}' list of disabled months is not empty")
    ...
    @JDIAction(value = "Assert that '{name}' enabled months are clickable")
    ...
    @JDIAction(value = "Assert that '{name}' disabled months are non-clickable")
    ...
    @JDIAction(value = "Assert that all chosen months are correctly chosen")
    ...
    @JDIAction(value = "Assert that '{name}' has month field")
