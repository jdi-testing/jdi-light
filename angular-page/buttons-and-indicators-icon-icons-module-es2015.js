...
IconOverviewExample.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: IconOverviewExample, selectors: [["icon-overview-example"]], decls: 5, vars: 0, consts: [[1, "example-h2"], ["href", "https://material.angular.io/components/icon/overview"], ["aria-hidden", "false", "id", "basic_icon", "aria-label", "Example home icon"]], template: function IconOverviewExample_Template(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](IconOverviewExample, [{
...
IconSvgExample.ɵfac = function IconSvgExample_Factory(t) { return new (t || IconSvgExample)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_material_icon__WEBPACK_IMPORTED_MODULE_1__["MatIconRegistry"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["DomSanitizer"])); };
IconSvgExample.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: IconSvgExample, selectors: [["icon-svg-example"]], decls: 4, vars: 0, consts: [[1, "example-h2"], ["href", "https://material.angular.io/components/icon/overview#svg-icons"], ["svgIcon", "thumbs-up", "aria-hidden", "false", "id", "svg_icon", "aria-label", "Example thumbs up SVG icon"]], template: function IconSvgExample_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "h2", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "a", 1);
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](IconSvgExample, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
...
/* harmony import */ var _icons_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./icons.component */ "./src/app/buttons-and-indicators/icon/icons.component.ts");
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _components_icon_overview_example__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/icon-overview-example */ "./src/app/buttons-and-indicators/icon/components/icon-overview-example.ts");
/* harmony import */ var _components_icon_svg_example__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/icon-svg-example */ "./src/app/buttons-and-indicators/icon/components/icon-svg-example.ts");
...
IconsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: IconsComponent, selectors: [["app-icons"]], decls: 2, vars: 0, template: function IconsComponent_Template(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: [_components_icon_overview_example__WEBPACK_IMPORTED_MODULE_1__["IconOverviewExample"], _components_icon_svg_example__WEBPACK_IMPORTED_MODULE_2__["IconSvgExample"]], encapsulation: 2 });
...
/* harmony import */ var _icons_routing_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./icons-routing.module */ "./src/app/buttons-and-indicators/icon/icons-routing.module.ts");
/* harmony import */ var _icons_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./icons.component */ "./src/app/buttons-and-indicators/icon/icons.component.ts");
/* harmony import */ var _components_icon_overview_example__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/icon-overview-example */ "./src/app/buttons-and-indicators/icon/components/icon-overview-example.ts");
/* harmony import */ var _components_icon_svg_example__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/icon-svg-example */ "./src/app/buttons-and-indicators/icon/components/icon-svg-example.ts");
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](IconsModule, { declarations: [_icons_component__WEBPACK_IMPORTED_MODULE_3__["IconsComponent"], _components_icon_overview_example__WEBPACK_IMPORTED_MODULE_4__["IconOverviewExample"], _components_icon_svg_example__WEBPACK_IMPORTED_MODULE_5__["IconSvgExample"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"],
        _icons_routing_module__WEBPACK_IMPORTED_MODULE_2__["IconsRoutingModule"],
        _angular_material_icon__WEBPACK_IMPORTED_MODULE_6__["MatIconModule"]] }); })();
...
//# sourceMappingURL=buttons-and-indicators-icon-icons-module-es2015.js.map