...
import static io.github.com.pages.BootstrapPage.fileInput;
import static io.github.com.pages.BootstrapPage.uploadFile;
...
public class InputGroupFileInputTests extends TestsInit {
    ...
    String filePath() { return mergePath(PROJECT_PATH,FILE_NAME); }
    ...
    public void labelTextTests() {
        ...
        uploadFile.has().value(containsString(filePath()));
    }
//
//    @Test
