...
import static io.github.com.pages.BootstrapPage.navsJustify;
...
public class FillAndJustifyTests extends TestsInit {

    private static final String JS_SCROLL_TO_ELEMENT = "arguments[0].scrollIntoView(true);";
    private static final String HEADER_RIGHT_PART = "#nav-pills";
    ...
    public void isValidationTests() {
        ...
        navsJustify.navItemLink.get(1)
                .is()
                .core()
                .hasClass("active");
        navsJustify.navItemLink.get(4)
                .is()
                .core()
                .hasClass("disabled");
    }
