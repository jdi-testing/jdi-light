...
public class BootstrapPage extends WebPage {
    ...
    @UI("#linkDropdown") public static Dropdown linkDropdown;
    @UI("#primaryDropdown") public static Dropdown primaryDropdown;
    @UI("#successDropdown") public static Dropdown successDropdown;
    @UI("#infoDropdown") public static Dropdown infoDropdown;
    @UI("#splitDropdown") public static Dropdown splitDropdown;
    @UI("#largeDropdown") public static Dropdown largeDropdown;
    @UI("#largeSplitDropdown") public static Dropdown largeSplitDropdown;
    @UI("#smallDropdown") public static Dropdown smallDropdown;
    @UI("#smallSplitDropdown") public static Dropdown smallSplitDropdown;
    @UI("#dropUpDropdown") public static Dropdown dropUpDropdown;
    @UI("#dropUpSplitDropdown") public static Dropdown dropUpSplitDropdown;
    @UI("#dropRightDropdown") public static Dropdown dropRightDropdown;
    @UI("#dropRightSplitDropdown") public static Dropdown dropRightSplitDropdown;
    @UI("#dropLeftDropdown") public static Dropdown dropLeftDropdown;
    @UI("#dropLeftSplitDropdown") public static Dropdown dropLeftSplitDropdown;
    @UI("#rightAllignedDropdown") public static Dropdown rightAllignedDropdown;
    @UI("#leftAllignedDropdown") public static Dropdown leftAllignedDropdown;
