...
public class ProgressAssert extends UIAssert<ProgressAssert, Progress> {
    ...
    public ProgressAssert height(Integer height) {
        return height(Matchers.is(height));
    }
}
