...
public class PaperTests extends TestsInit {
    ...
    private static final String ZERO_ELEVATION = "Paper with elevation = 0";
    private static final String DEFAULT_ELEVATION = "Paper with default elavation";
    private static final String ELEVATION_EQUALS_THREE = "Paper with elevation = 3";
    private static final String OUTLINED_ROUNDED = "Outlined paper";
    private static final String OUTLINED_SQUARE = "Outlined square paper";
