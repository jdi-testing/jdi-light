...
public @interface JDITransferList {
     ...
     * This locator for {@link TransferList} and {@link EnhancedTransferList}
     */
    ...
    /**
     * Locator for {@link TransferList} button which moving all items to the right list
     */
    @MarkupLocator String moveAllRightButton() default "";
    /**
     * Locator for {@link TransferList} button which moving all items to the left list
     */
    ...
    /**
     * Locator for {@link EnhancedTransferList} left card header checkbox which selected all items
     */
    @MarkupLocator String allItemsLeftCheckbox() default "";
    /**
     * Locator for {@link EnhancedTransferList} right card header checkbox which selected all items
     */
