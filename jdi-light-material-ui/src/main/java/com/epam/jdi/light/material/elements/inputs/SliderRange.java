...
public class SliderRange extends UIBaseElement<SliderRangeAssert> {
  ...
  private final static String ariaValuenow = "aria-valuenow";
  ...
  private void setAttributes(int thumbIndex, int value, String newThumbStyle) {
    thumb(thumbIndex).setAttribute(ariaValuenow, String.valueOf(value));
  ...
  public int value(int index) {
    return getInteger(ariaValuenow, thumb(index).core(), 0);
  }
