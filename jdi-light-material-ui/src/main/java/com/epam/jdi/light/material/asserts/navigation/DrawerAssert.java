...
//        jdiAssert(!element().isDisplayed() ? "is visible" : "is not visible", Matchers.is("is visible"));
//        return this;
//    }
...
//        jdiAssert(element().isDisplayed() ? "is not visible" : "is visible", Matchers.is("is not visible"));
//        return this;
//    }
...
//        jdiAssert(element().isDisplayed() ? "is hidden" : "is visible", Matchers.is("is hidden"));
//        return this;
//    }
