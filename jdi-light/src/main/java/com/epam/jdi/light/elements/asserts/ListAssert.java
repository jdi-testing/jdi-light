...
public class ListAssert {
    ...
    public void texts(Matcher<Iterable<String>> condition) {
        assertThat(values, condition);
    }
    public void attrs(String attrName, Matcher<Iterable<String>> condition) {
        assertThat(map(elements, el -> el.getAttribute(attrName)), condition);
    }
    public void css(String css, Matcher<Iterable<String>> condition) {
        assertThat(map(elements, el -> el.getCssValue(css)), condition);
    }
    public void tags(Matcher<Iterable<String>> condition) {
        assertThat(map(elements, WebElement::getTagName), condition);
    }
    public void cssClasses(Matcher<Iterable<String>> condition) {
