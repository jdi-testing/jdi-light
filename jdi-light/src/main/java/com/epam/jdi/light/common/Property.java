...
public enum Property {
    ...
    //SCREENS_FOLDER("screens.folder", "^[a-zA-Z]:\\\\[\\\\\\S|*\\S]?.*$", "'screens.folder' must contain the correct folder path"),
    SCREENS_FOLDER("screens.folder", "^(.*/)([^/]*)$", "'screens.folder' must contain the correct folder path"),
