...
public class TimeoutWaitPageTests {
    ...
    public void negativeTest(String value) {
        ...
        properties.setProperty(TIMEOUT_WAIT_PAGE.getName(), value);
        try {
            validateProperties(properties);
            fail("Value '" + value + "' should not be valid for this test.");
        } catch (InvalidParameterException exp) {
            String expMessage = exp.getMessage();
            assertEquals(expMessage, TIMEOUT_WAIT_PAGE.getExMsg() + " See example: https://jdi-docs.github.io/jdi-light/#driver-settings");
        }
    }
