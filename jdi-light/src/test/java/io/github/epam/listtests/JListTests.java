...
public class JListTests extends ListTestsInit {
    ...
    public void seleniumJListTest() {
        ...
        assertEquals(jList.get(0).getText(), element0Text);
        assertEquals(jList.get(1).getText(), element1Text);
    }
    ...
    public void jdiJListTest() {
        ...
        assertEquals(jList.get(1).getText(), element0Text);
        assertEquals(jList.get(2).getText(), element1Text);
    }
