...
public class CoordinateConversionHelper {
    ...
    static {
        ...
        if (driver instanceof AndroidDriver) {
            TOOLBAR = d -> ((AndroidDriver) d).findElement(AppiumBy.id(androidToolbarId)).getRect();
            WEBVIEW = d -> ((AndroidDriver) d).findElement(AppiumBy.className(androidWebviewClassName)).getRect();
        } else if (driver instanceof IOSDriver) {
            TOOLBAR = d -> ((IOSDriver) d).findElement(AppiumBy.accessibilityId(iosToolbarAccessibilityId)).getRect();
            WEBVIEW = d -> {
                Rectangle topToolbar = ((IOSDriver) d).findElement(AppiumBy.accessibilityId(iosToolbarAccessibilityId)).getRect();
                Rectangle bottomToolbar = ((IOSDriver) d).findElement(AppiumBy.accessibilityId(iosBottomToolbarAccessibilityId)).getRect();
