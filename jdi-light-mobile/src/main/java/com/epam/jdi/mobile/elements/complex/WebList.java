...
import com.epam.jdi.mobile.common.JDILocator;
...
import static com.epam.jdi.mobile.common.TextTypes.INDEX;
import static com.epam.jdi.mobile.common.TextTypes.SMART_LIST;
import static com.epam.jdi.mobile.driver.WebDriverByUtils.shortBy;
...
////
    ...
    public String selected() {
        refresh();
        UIElement first = WebSettings.logger.logOff(() -> first(UIElement::isSelected) );
