...
public class ScreenshotMaker {
    public static String SCREEN_PATH = DriverData.LOGS_PATH + "\\screens";
    public static String SCREEN_NAME = "screen";
    public static String SCREEN_FILE_SUFFIX = ".jpg";
    public static AllureLoggerHelper.AttachmentStrategy SCREENSHOT_STRATEGY = AllureLoggerHelper.AttachmentStrategy.ON_FAIL;
    public static String takeScreenOnFailure() {
        return SCREENSHOT_STRATEGY == AllureLoggerHelper.AttachmentStrategy.ON_FAIL
            ? takeScreen()
            : null;
    }
    ...
    public static String getPath() {
        ...
        return result.contains(":")
            ? SCREEN_PATH
            : DriverData.PROJECT_PATH + SCREEN_PATH;
    }
    public String takeScreenshot() {
        String name = WebSettings.TEST_NAME.get();
    ...
    public String takeScreenshot(String name, String dateFormat) {
        ...
        WebSettings.logger.info("Screenshot: " + screensFilePath);
