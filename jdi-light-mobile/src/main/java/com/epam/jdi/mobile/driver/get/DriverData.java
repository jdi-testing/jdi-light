...
public class DriverData {
    ...
    public static String chromeDriverPath() {
        return mergePath(getDriverFolder(),getOs() == OsTypes.WIN ? "chromedriver.exe" : "chromedriver");
    }
    ...
    private static String driverPath(String driverName) {
        return mergePath(getDriverFolder(), getOs() == OsTypes.WIN ? driverName + ".exe" : driverName);
    }
    ...
    public static OsTypes getOs() {
        ...
        return Switch(osName).get(
            SwitchActions.Case(os -> os.contains("mac"), OsTypes.MAC),
            SwitchActions.Case(os -> os.contains("win") || os.contains("ms"), OsTypes.WIN),
            SwitchActions.Default(OsTypes.LINUX)
        );
    }
