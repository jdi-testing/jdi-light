...
import com.epam.jdi.mobile.asserts.generic.table.DataTableAssert;
    ...
    private D lineToData(L line) {
        ...
        for (Field lineField : lineFields) {
            for (Field dataField : dataFields) {
                if (namesEqual(WebAnnotationsUtil.getElementName(lineField), WebAnnotationsUtil.getElementName(dataField))) {
